...
const Auth = (() => {
  ...
  async function entrarDemo() {
    const data = criarSessaoLocal({ nome: 'Teste EVOLUE', email: 'teste@evolue.local' });
    window.dispatchEvent(new CustomEvent('evolue:login', { detail: { usuario: _usuario, perfil: _perfil } }));
    return data;
  }
  ...
  return { init, cadastrar, entrar, entrarComGoogle, entrarDemo, sair, resetarSenha, getUsuario, getPerfil, estaLogado, atualizarPerfil, carregarPerfil };
})();
